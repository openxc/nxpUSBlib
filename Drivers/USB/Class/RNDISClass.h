 ...
 *    - LPCUSBlib/Drivers/USB/Class/Device/RNDIS.c <i>(Makefile source module name: LPCUSBlib_SRC_USBCLASS)</i>
 ...
 *  RNDIS class manually via the low-level LPCUSBlib APIs.
 *
